  ...
  const steps = [
    {
      ...
      description: 'Connect your Web3 wallet to get started. No KYC required - just connect and start earning.',
      time: '30 seconds',
    ...
    },
    {
      ...
      icon: DollarSign,
      title: 'Deposit USDC',
      description: 'Start with as little as 1 USDC. Funds automatically deploy to Aave V3. Interest starts immediately.',
      time: '30 seconds',
